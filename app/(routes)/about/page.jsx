...
const About = () => {
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <p className="font-semibold text-sm leading-3 text-[#7f1790] pb-2">
        About
      </p>
      <div className="flex lg:flex-row flex-col lg:gap-x-16 sm:gap-10 gap-12">
        <div className="w-full lg:w-[45%]">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            Transforming Real Estate for Everyone, Everywhere
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Welcome to our real estate platform, where we believe in making the
            process of buying, selling, and renting properties not just easy,
            but delightful for everyone. Our mission is to bridge the gap
            between property seekers and owners, creating a seamless experience
            that is transparent, efficient, and enjoyable.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Founded on the principles of trust, innovation, and
            customer-centricity, we strive to provide a comprehensive and
            user-friendly platform that caters to all your real estate needs.
            Whether you are looking to find your dream home, invest in
            properties, or rent an apartment, our goal is to ensure that you
            have access to the best resources and support every step of the way.
          </p>
        </div>
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Established in 2010, our platform has grown to become a trusted
            space for property listings, providing a seamless experience for
        ...
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Our website attracts over 50 million monthly views, offering
            unparalleled visibility for your property listings and ensuring a
            wide audience reach.
          </p>
        </div>
        <div className="sm:block hidden">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Join our vibrant community of over 400,000 active users who are
            exploring, listing, and discovering properties across various
            locations every day.
          </p>
        </div>
      </div>
